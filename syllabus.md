...
- [About Stat 206b](#about-stat-206b)
  - [Goals](#goals)
...
While we are working to make this class widely accessible, we currently require the following (or equivalent) prerequisites. **Prerequisites will be enforced in Stat 206b. It is your responsibility to know the material in the prerequisites.** 
